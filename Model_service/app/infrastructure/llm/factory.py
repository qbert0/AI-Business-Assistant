...
def build_llm_client(model: db_models.RegisteredModel, api_key: str | None, timeout_seconds: int) -> BaseLLMClient:
    provider_type = model.provider.provider_type
    if provider_type == "openai_compatible":
        return OpenAICompatibleClient(model.base_url, model.model_name, api_key, timeout_seconds)
