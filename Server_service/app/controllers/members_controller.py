...
def add_member(
    ...
    member = members_repository.add_member(org_id, payload, acting_user_id, db)
...
def list_members(
    ...
    members = members_repository.list_members(org_id, acting_user_id, search, skip, limit, db)
    return member_dto.to_member_models(members)
...
def update_member(
    ...
    member = members_repository.update_member(org_id, member_id, payload, acting_user_id, db)
    return common_dto.to_member_model(member)
...
def delete_member(
    ...
    return members_repository.delete_member(org_id, member_id, acting_user_id, db)
...
def leave_organization(
    ...
    return members_repository.leave_organization(org_id, acting_user_id, db)
